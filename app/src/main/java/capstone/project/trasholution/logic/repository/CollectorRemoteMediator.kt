...
class CollectorRemoteMediator(
    ...
    override suspend fun load(
        ...
        try {
            val responseData = apiService.getPengepul().data
...
//            }
            ...
            database.withTransaction {
                if (loadType == LoadType.REFRESH) {
                    ...
                    database.pengepulDao().deleteAll()
                }
                ...
                database.pengepulDao().insertPengepul(responseData)
            }
